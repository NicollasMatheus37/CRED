...
public class BuscaAlunoWindow extends BuscaWindowGeneric {
		...
		txfBuscar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent a) {
				...
				if (comboBusca.getSelectedItem().toString().equals("Código") && !txfBuscar.getText().equals("")) {
					...
					model.addListaDeAlunos(new AlunosDAO().consultar(Integer.valueOf(txfBuscar.getText())));

				} else {

					if (comboBusca.getSelectedItem().toString().equals("Nome") && !txfBuscar.getText().equals("")) {

						model.addListaDeAlunos(new AlunosDAO().consultar(txfBuscar.getText()));
	...
	public void mostrarTodos() {
		try {
			...
			model.addListaDeAlunos(new AlunosDAO().consultar(false));
		} catch (Exception e) {
